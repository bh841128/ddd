package com.cvt.io.integration;

import com.cvt.io.IXI;
import com.cvt.io.CVT;
...
import static com.cvt.io.controllers.TransactionViewModel.*;
...
public class NodeIntegrationTests {
    ...
    private CVT newNode(int index, TemporaryFolder db, TemporaryFolder log) throws Exception {
        db.create();
        log.create();

...
public class GetNeighborsResponse extends AbstractResponse {
    ...
    static class Neighbor {
        ...
        public static Neighbor createFrom(com.cvt.io.network.Neighbor n) {
    ...
    public static AbstractResponse create(final List<com.cvt.io.network.Neighbor> elements) {
        GetNeighborsResponse res = new GetNeighborsResponse();
        res.neighbors = new Neighbor[elements.size()];
        int i = 0;
        for (com.cvt.io.network.Neighbor n : elements) {

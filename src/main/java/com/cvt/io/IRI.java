...
public class IRI {
    ...
    public static void validateParams(final Configuration configuration, final String[] args) throws IOException {
        ...
        final Option<String> accountDBPath = parser.addStringOption("accountDBPath");
        final Option<String> accountDBLogPath = parser.addStringOption("accountDBLogPath");
        ...
        if(parser.getOptionValue(accountDBPath)!=null) {
        	configuration.put(DefaultConfSettings.ACCOUNTDB_PATH.name(),parser.getOptionValue(accountDBPath));
        }
        if(parser.getOptionValue(accountDBLogPath)!=null) {
        	configuration.put(DefaultConfSettings.ACCOUNTDB_LOG_PATH.name(), parser.getOptionValue(accountDBLogPath));
        }
